        ...
        <div className="bg-gray-50 py-16 px-4 sm:px-6 lg:col-span-3 lg:py-24 lg:px-8 xl:pl-12">
          <div className="mx-auto max-w-lg lg:max-w-none">
            <form action="#" method="POST" className="grid grid-cols-1 gap-y-6">
              ...
              <div>
                    <input type="checkbox" name="Privacidad" value="1" aria-invalid="false"></input>
                    <span class="pl-2">He leído y acepto la política de  <a href="https://iktanstrategies.com/politicas-de-privacidad"> privacidad</a></span>
                </div>
            </form>
            </div>
        </div>
